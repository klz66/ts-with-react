 ...
 * @LastEditTime: 2021-03-22 16:49:16
 */
...
export const getDetail = (id) => {
    ...
    console.log(res);
    if(res.code === 20000) {
      let title = formatTitle(res.data.blogDetail.content)
      console.log(title);
      dispatch(changeDetail(title, res.data.blogDetail.content));
    }
	}
};
export const getTrashDetail = (id) => {
    ...
    console.log(res);
    if(res.code === 20000) {
      dispatch(changeDetail(formatTitle(res.data.blogDetail.content), res.data.blogDetail.content));
    }
	}
};
